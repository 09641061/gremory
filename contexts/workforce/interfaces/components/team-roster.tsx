...
export function TeamRoster({ establishmentId = null }: { establishmentId?: string | null }) {
  ...
  const canRead = hasPermission("workforce:member:read");
  const canInvite = hasPermission("workforce:member:invite");
  const canAssignRoles = hasPermission("workforce:member:manage");
